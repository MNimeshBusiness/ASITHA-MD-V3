...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=u6g0lLiT#eIVQD7K5DQT__-En0-Ewu-VAjSdOSwRWran6W_BVniI' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '94742752063' : process.env.SUDO,
SESSION_NAME: process.env.PORT === undefined ? "Nimesh" : process.env.SESSION_NAME,
